...
class PlayerActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    // Long-press the settings icon to open Quality picker (non-invasive to default menu).
    // Note: Uses Media3 internal id for the settings button.
    playerView.post {
      val settingsBtnId = androidx.media3.ui.R.id.exo_settings
      playerView.findViewById<View?>(settingsBtnId)?.setOnLongClickListener {
